...
## MDI.TransmissionLine.TransmissionLineConstraints module
...
### MDI.TransmissionLine.TransmissionLineConstraints.add_transmission_line_flow_constraints(m: ConcreteModel) → ConcreteModel
...
### MDI.TransmissionLine.TransmissionLineConstraints.add_transmission_line_flow_limits_constraints(m: ConcreteModel) → ConcreteModel
...
- These constraints should be added after
  [`add_transmission_line_flow_constraints()`](#MDI.TransmissionLine.TransmissionLineConstraints.add_transmission_line_flow_constraints).

### MDI.TransmissionLine.TransmissionLineConstraints.add_transmission_line_investment_link_constraints(m)
...
## MDI.TransmissionLine.TransmissionLineDataTypes module
...
### *class* MDI.TransmissionLine.TransmissionLineDataTypes.TransmissionLineData(horizon: int, units: Dict[str, [TransmissionLineUnit](#MDI.TransmissionLine.TransmissionLineDataTypes.TransmissionLineUnit)])
...
* **Parameters:**
  ...
  * **units** (*dict*) – Mapping of line identifiers to their respective
    [`TransmissionLineUnit`](#MDI.TransmissionLine.TransmissionLineDataTypes.TransmissionLineUnit) instances.
...
#### units *: Dict[str, [TransmissionLineUnit](#MDI.TransmissionLine.TransmissionLineDataTypes.TransmissionLineUnit)]*

### *class* MDI.TransmissionLine.TransmissionLineDataTypes.TransmissionLineUnit(name: str, state: int, c_op: float, c_inv: float, model: str, b: float, pmax: float, endpoints: List[str])
...
* **Parameters:**
  ...
  * **state** (*int*) – Initial state (0 = not installed, 1 = existing).
  * **c_op** (*float*) – Operational cost (per MWh of discharge or equivalent).
  * **c_inv** (*float*) – Investment cost (annualized).
...
## MDI.TransmissionLine.TransmissionLineEquations module
...
### MDI.TransmissionLine.TransmissionLineEquations.add_transmission_line_balance_expression(m: ConcreteModel, b: Any, t: Any, p: Any, balance_array: List[Any]) → List[Any]
...
* **Parameters:**
  ...
  * **t** (*int/Any*) – Time period index.
  * **p** (*str/Any*) – level index.
  * **balance_dict** (*Dict* *[**str* *,* *List* *[**Any* *]* *]*) – Dictionary indexed by bar name. Each entry is a list of symbolic
...
### MDI.TransmissionLine.TransmissionLineEquations.add_transmission_line_cost_expression(m: ConcreteModel, cost_array: List[Any]) → List[Any]
...
## MDI.TransmissionLine.TransmissionLineBuilder module
...
### MDI.TransmissionLine.TransmissionLineBuilder.add_transmission_line_problem(m: ConcreteModel, data: [TransmissionLineData](#MDI.TransmissionLine.TransmissionLineDataTypes.TransmissionLineData), include_objective: bool = False) → ConcreteModel
...
* **Parameters:**
  ...
  * **include_objective** (*bool* *,* *optional*) – Reserved argument for interface compatibility (default `False`).
...
### MDI.TransmissionLine.TransmissionLineBuilder.build_transmission_lines(data: [TransmissionLineData](#MDI.TransmissionLine.TransmissionLineDataTypes.TransmissionLineData), include_objective: bool = True) → ConcreteModel
...
* **Parameters:**
  * **data** ([*TransmissionLineData*](NaivePyDESSEM.TransmissionLine.md#NaivePyDESSEM.TransmissionLine.TransmissionLineDataTypes.TransmissionLineData)) – 
...
- The function internally calls [`add_transmission_line_problem()`](#MDI.TransmissionLine.TransmissionLineBuilder.add_transmission_line_problem),
...
## MDI.TransmissionLine.TransmissionLineVars module
...
### MDI.TransmissionLine.TransmissionLineVars.transmission_line_add_sets_and_params(m: ConcreteModel, data) → ConcreteModel
...
### MDI.TransmissionLine.TransmissionLineVars.transmission_line_add_variables(m: ConcreteModel) → ConcreteModel
