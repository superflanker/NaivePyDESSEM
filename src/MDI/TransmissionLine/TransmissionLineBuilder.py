...
from .TransmissionLineConstraints import (
    ...
    add_transmission_line_investment_link_constraints
)
...
def build_transmission_lines(data: TransmissionLineData,
    ...
    """
    m = ConcreteModel()
    m.unique_bar = False # avoid the restriction of having a unique bar for testing
...
def add_transmission_line_problem(m: ConcreteModel,
    ...
    if not m.unique_bar:
        ...
        add_transmission_line_investment_link_constraints(m)
    return m
