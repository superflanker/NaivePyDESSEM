...
pydecomp-solve examples/TRANSMISSION_LINES/decomp.yaml --out_dir resultados/TRANSMISSION_LINES/ --out_file decomp_single_pl.csv
...
pydecomp-pddd-solve examples/TRANSMISSION_LINES/decomp.yaml --out_dir resultados/TRANSMISSION_LINES/ --out_file decomp_pddd.csv
